...
(function(){
  ...
  Router = (function(){
    ...
    function Router(){
      ...
      this.methodList = ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'HEAD', 'OPTIONS'];
      this.handlerList = [];
      self = this;
    ...
    prototype.register = function(pattern, handler, methodList){
      var arr, i$, len$, item, paramRe, paramNames, that, results$ = [];
      arr = [];
    ...
    prototype.route = function(ctx){
      var self, pathname, matched, i$, ref$, len$, item, pattern, handler, methodList, paramNames, mArr, j$, len1$, idx, name;
      self = this;
